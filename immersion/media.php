...
$arr_media = get_user_by_id($edit_id);
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="user_media.php?id=<?= $edit_id?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?= $path_img;?><?= $arr_media['img'];?>" alt="" class="img-responsive" width="200">
                                </div>

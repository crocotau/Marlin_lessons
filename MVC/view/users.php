...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <?php elseif (isset($_SESSION['add_user_success'])):?>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <a class="btn btn-success" href="../controller/create_user.php">Добавить</a>
                    <?php endif;?>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?= $path_img;?><?= $item['img'];?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php elseif($item['id']==$_SESSION['id']):?>
                                        <i class="fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>
                                        <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                        <?php endif;?>
                                    </a>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="../view/page_profile.php?id=<?= $item['id']?>">
                                            <i class="fa fa-edit"></i>
                                            Просмотреть</a>
                                        <a class="dropdown-item" href="../view/edit.php?id=<?= $item['id']?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="../view/security.php?id=<?= $item['id']?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="../view/status.php?id=<?= $item['id']?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="../view/media.php?id=<?= $item['id']?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="../controller/user_del.php?id=<?= $item['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                    ...
                                    <?php elseif (isset($_SESSION['id'])):?>
                                        <a href="page_profile.php?id=<?= $item['id']?>" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false"></a>
                                        <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="../view/page_profile.php?id=<?= $item['id']?>">
                                            <i class="fa fa-edit"></i>
